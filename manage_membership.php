		...
		<div id="msg"></div>
			<div class="form-group">
				...
				<select name="member_id" required="required" class="custom-select select2" id="">
					...
					<?php
						$qry = $conn->query("SELECT id ,concat(lastname,', ',firstname,' ',middlename) as fullname FROM members where id in (SELECT member_id from registration_info where status = 0) order by concat(lastname,', ',firstname,' ',middlename) asc");
